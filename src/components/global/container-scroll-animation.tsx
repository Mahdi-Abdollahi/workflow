...
export const ContainerScroll = ({
  ...
  const scaleDimensions = () => {
    return isMobile ? [0.7, 0.9] : [1.0, 1];
  };

  const rotate = useTransform(scrollYProgress, [0, 1], [20, 0]);
  const scale = useTransform(scrollYProgress, [0, 1.2], scaleDimensions());
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[50rem] w-full  p-6 bg-[#222222] rounded-[30px] shadow-2xl "
    >
